...
- Hycom 자료 설명 : [Hycom Homepage](https://www.hycom.org/)
- Hycom 자료 FTP : [Hycom FTP](ftp://ftp.hycom.org/datasets/GLBv0.08/expt_93.0/data/hindcasts/2020/)
...
- NetCDF4 API documentation : [NetCDF4 API documentation](https://unidata.github.io/netcdf4-python/netCDF4/index.html)
...
> If you want to stick with Basemap, get a shapefile which doesnt contain the rivers. Natural Earth for example has a nice 'Land' shapefile in the physical section (download 'scale rank' data and uncompress). See [Get Land Data](http://www.naturalearthdata.com/downloads/10m-physical-vectors/)
> 
> (링크 [Stack Overflow](https://stackoverflow.com/questions/14280312/world-map-without-rivers-with-matplotlib-basemap))
